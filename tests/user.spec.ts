...
describe("User class tests", () => {
    it("User constructor", () => {
        expect(new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]))).to.be.instanceof(User);
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["pepaso", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]))).to.throw(
            "Un usuario no puede ser amigo de sí mismo"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([-1, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]))).to.throw(
            "ID -1 del grupo 0 no válido"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5.5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]))).to.throw(
            "ID 5.5 del grupo 1 no válido"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([-6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]))).to.throw(
            "ID -6 de la ruta 0 no válido"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4.5]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]))).to.throw(
            "ID 4.5 de la ruta 1 no válido"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([-1, 3]), new Set<[Date, number]>([[new Date(), 4]]))).to.throw(
            "ID -1 del reto 0 no válido"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3.5]), new Set<[Date, number]>([[new Date(), 4]]))).to.throw(
            "ID 3.5 del reto 1 no válido"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date('2025-12-17T03:24:00'), 4]]))).to.throw(
            "La fecha de una ruta del historial no puede ser futura"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), -1]]))).to.throw(
            "ID -1 de la ruta 0 del historial no válido"
        );
        expect(() => new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4.5]]))).to.throw(
            "ID 4.5 de la ruta 0 del historial no válido"
        );
    });

    it("id property", () => {
        const user: User = new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]));
    ...
    it("addFriend function", () => {
        ...
        expect(user.addFriend(new User("tomasote", "Tomás", Activities.BICICLETA, new Set<string>(["pepaso", "marcelo"]), new Set<number>([2, 4]), new Statistics(5, 250, 15, 600, 80, 5500), new Set<number>([6, 4, 8]), new Set<number>([1, 3, 4]), new Set<[Date, number]>([[new Date(), 4,], [new Date("2022-12-17T03:24:00"), 2]])))).to.be.true;
        ...
        expect(user.addFriend(new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]])))).to.be.false;
        expect(user.addFriend(new User("tomasote", "Tomás", Activities.BICICLETA, new Set<string>(["pepaso", "marcelo"]), new Set<number>([2, 4]), new Statistics(5, 250, 15, 600, 80, 5500), new Set<number>([6, 4, 8]), new Set<number>([1, 3, 4]), new Set<[Date, number]>([[new Date(), 4,], [new Date("2022-12-17T03:24:00"), 2]])))).to.be.false;
    });

    it("removeFriend function", () => {
        const user: User = new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo", "alfredillo", "tomasote"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]));
        expect(user.removeFriend("alfredillo")).to.be.true;
        expect(user.friends).to.be.eql(new Set<string>(["rodrigodigo", "marcelo", "tomasote"]));
        expect(user.removeFriend(new User("tomasote", "Tomás", Activities.BICICLETA, new Set<string>(["pepaso", "marcelo"]), new Set<number>([2, 4]), new Statistics(5, 250, 15, 600, 80, 5500), new Set<number>([6, 4, 8]), new Set<number>([1, 3, 4]), new Set<[Date, number]>([[new Date(), 4,], [new Date("2022-12-17T03:24:00"), 2]])))).to.be.true;
        expect(user.friends).to.be.eql(new Set<string>(["rodrigodigo", "marcelo"]));
        expect(user.removeFriend("alfredillo")).to.be.false;
        expect(user.removeFriend(new User("tomasote", "Tomás", Activities.BICICLETA, new Set<string>(["pepaso", "marcelo"]), new Set<number>([2, 4]), new Statistics(5, 250, 15, 600, 80, 5500), new Set<number>([6, 4, 8]), new Set<number>([1, 3, 4]), new Set<[Date, number]>([[new Date(), 4,], [new Date("2022-12-17T03:24:00"), 2]])))).to.be.false;
    });
    ...
    it("removeGroup function", () => {
        const user: User = new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5, 7, 8]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]));
    ...
    it("statistics property", () => {
        const user: User = new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]));
        expect(user.statistics).to.be.eql(new Statistics(5, 200, 10, 500, 50, 4000));
        user.statistics = new Statistics(8, 250, 12, 400, 60, 3000);
        expect(user.statistics).to.be.eql(new Statistics(8, 250, 12, 400, 60, 3000));
    });
    ...
    it("removeFavouriteRoute function", () => {
        const user: User = new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4, 7, 8]), new Set<number>([1, 3]), new Set<[Date, number]>([[new Date(), 4]]));
    ...
    it("removeActiveChallenge function", () => {
        const user: User = new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3, 7, 8]), new Set<[Date, number]>([[new Date(), 4]]));
    ...
    it("removeRouteFromHistorical function", () => {
        const user: User = new User("pepaso", "Pepe", Activities.CORRER, new Set<string>(["rodrigodigo", "marcelo"]), new Set<number>([2, 5]), new Statistics(5, 200, 10, 500, 50, 4000), new Set<number>([6, 4]), new Set<number>([1, 3, 7, 8]), new Set<[Date, number]>([[new Date(), 4], [new Date('2022-12-17T03:24:00'), 2], [new Date('2021-08-12T03:24:00'), 3]]));
